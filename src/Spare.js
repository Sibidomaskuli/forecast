                                    ...
                                    <div className="card text-center">
                                       <div className="card-body">
                                          <span className="column-1">
                                             ...
                                             />
                                             <br />
                                             <p className="card-text">max 5° min 2°</p>
                                       ...
                                       <div className="card-body">
                                          <div className="card-border text-primary">
                                             <span className="column-2">
                                                ...
                                                />
                                                <br />
                                                <p className="card-text">max 2° min 0°</p>
                                                <small>windy</small>
                                             </span>
                                          </div>
                                       </div>
                                       ...
                                       <div className="card-body">
                                          <span className="column-3">
                                             <div className="card-header bg-transparent border-success">
                                                <span className="colThree-weekday">
                                                   Saturday
                                </span>
                                                <br />
                                             </div>
                                             ...
                                             />
                                             <br />
                                             <p className="card-text">max 7° min 4°</p>
                                             <small>cloudy</small>
                                          </span>
                                       </div>
                                    </div>
                                    ...
                                    <div className="card text-center">
                                       <div className="card-body">
                                          <span className="column-4">
                                             ...
                                             />
                                             <br />
                                             <p className="card-text">max 12° min 9°</p>
                                             <small>sunny</small>
                                          </span>
                                       </div>
                                    </div>
                                       ...
                                       <div className="card-body">
                                          <div className="card-border text-primary">
                                             <span className="column-5">
                                                <div className="card-header bg-transparent border-primary">
                                                   <span className="colFive-weekday">
                                                      Monday
                                  </span>
                                                   <br />
                                                </div>
                                                ...
                                                />
                                                <br />
                                                <p className="card-text">max 10° min 8°</p>
                                                <small>clear</small>
                                             </span>
                                          </div>
                                       </div>
                                    ...
                                    <div className="card text-center">
                                       <div className="card-body">
                                          <span className="column-6">
                                             ...
                                             />
                                             <br />
                                             <p className="card-text">max 6° min 4°</p>
                                             <small>cold</small>
                                          </span>
                                       </div>
                                    </div>
